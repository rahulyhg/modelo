    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="table2" data-toggle="table" data-height="299" data-show-footer="true">
                    <thead>
                    <tr>
                        <th data-field="id">ID</th>
                        <th data-field="body" data-footer-formatter="totalNameFormatter">Item Name</th>
                        <th data-field="nome">Nome</th>
                        <th data-field="preco">Preco</th>
                        <th data-field="qtde">qtde</th>
                        
                        <th data-field="operate" data-formatter="operateFormatter2" data-events="operateEvents2">Operate</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<script type="text/javascript" href="../bower_components/fuelux/dist/js/fuelux.min.js"></script>
<script type="text/javascript" href="../bower_components/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.js"></script>
